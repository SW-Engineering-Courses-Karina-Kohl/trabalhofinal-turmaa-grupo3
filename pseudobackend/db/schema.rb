...
ActiveRecord::Schema[8.1].define(version: 2026_06_03_051125) do
  ...
  create_table "exports", force: :cascade do |t|
    ...
    t.index ["seller_commission_report_id"], name: "index_exports_on_seller_commission_report_id"
  end
  ...
  add_foreign_key "exports", "seller_commission_reports"
